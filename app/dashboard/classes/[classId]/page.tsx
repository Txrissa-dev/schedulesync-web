      ...
      <div className="bg-white shadow-lg rounded-2xl p-6 border-t-4 border-brand-primary">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center gap-3 text-gray-700">
            ...
            <span className="font-medium">{classDetails.teacher?.name || 'No teacher assigned'}</span>
          </div>
          ...
          <div className="flex items-center gap-3 text-gray-700">
            ...
            <span className="font-medium">{classDetails.teacher?.full_name || 'No teacher assigned'}</span>
          </div>
