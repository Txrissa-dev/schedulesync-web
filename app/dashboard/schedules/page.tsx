...
export default function SchedulesPage() {
  ...
  const shouldGroupByTeacher = !isTeacherView
  const groupClassesByTeacher = (classList: ClassSchedule[]) => {
    ...
    return Object.entries(grouped).sort(([teacherA], [teacherB]) =>
      teacherA.localeCompare(teacherB)
    )
  }
  const groupedSelectedDateClasses = shouldGroupByTeacher
    ? groupClassesByTeacher(selectedDateClasses)
    : []
        ...
        <div className="bg-white shadow-lg rounded-2xl p-6">
          ...
          {selectedDateClasses.length === 0 ? (
            ...
            <div className="space-y-6">
              {shouldGroupByTeacher ? (
                groupedSelectedDateClasses.map(([teacherName, teacherClasses]) => (
